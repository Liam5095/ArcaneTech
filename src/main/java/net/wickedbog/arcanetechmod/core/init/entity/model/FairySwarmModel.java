package net.wickedbog.arcanetechmod.core.init.entity.model;// Made with Blockbench 4.10.4
...
public class FairySwarmModel<T extends Entity> extends EntityModel<T> {
	...
	public FairySwarmModel(ModelPart root) {

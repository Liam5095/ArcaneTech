package net.wickedbog.arcanetechmod.core.init.block.custom.energy.screen;
...
import net.wickedbog.arcanetechmod.core.init.MenuTypeInit;
...
import static net.wickedbog.arcanetechmod.core.init.block.custom.energy.entity.GeneratorBlockEntity.SLOT;
import static net.wickedbog.arcanetechmod.core.init.block.custom.energy.entity.GeneratorBlockEntity.SLOT_COUNT;
...
public class GeneratorContainer extends AbstractContainerMenu {
    ...
    public GeneratorContainer(int windowId, Player player, BlockPos pos) {
        super(MenuTypeInit.GENERATOR_CONTAINER.get(), windowId);
        this.pos = pos;

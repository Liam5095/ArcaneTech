...
import net.wickedbog.arcanetechmod.core.init.block.custom.energy.cables.ConnectorType;
...
import static net.wickedbog.arcanetechmod.core.init.block.custom.energy.cables.ConnectorType.*;
import static net.wickedbog.arcanetechmod.core.client.energy.cables.CablePatterns.SpriteIdx.*;
import static net.wickedbog.arcanetechmod.util.model_util.BakedModelHelper.quad;
import static net.wickedbog.arcanetechmod.util.model_util.BakedModelHelper.v;
...
public class CableBakedModel implements IDynamicBakedModel {
    ...
    private TextureAtlasSprite getTexture(String path) {
        return Minecraft.getInstance().getTextureAtlas(InventoryMenu.BLOCK_ATLAS).apply(new ResourceLocation(ArcaneTechMod.MOD_ID, path));
    }
